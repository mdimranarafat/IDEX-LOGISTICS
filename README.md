...
| `admin-app.js` | Admin panel logic (auth, CRUD, image compression to Base64) |
...
(No Firebase Storage needed — images are compressed in the browser and stored
directly inside the Firestore documents as Base64 Data URLs.)
...
| Image rejected | File isn't JPG/PNG/WebP, or is over 5MB |
| "Save failed" with large images | Too many gallery images per project — Firestore docs cap at 1MB; keep galleries small (each image compresses to well under 300KB) |
